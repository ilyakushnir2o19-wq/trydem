...
НОВОЕ В 2.1:
  - Бот теперь ОТВЕЧАЕТ на команды в Telegram:
      /start  - описание и параметры
      /status - что бот видит прямо сейчас (цена, тренд, объём, аптайм)
      /ping   - проверка, жив ли бот
  - Требуется requirements.txt (лежит рядом) — без него хостинг
    не установит ccxt/pandas/pandas_ta и контейнер упадёт.

Зависимости (requirements.txt):
  numpy<2, pandas, pandas_ta==0.3.14b0, ccxt, python-telegram-bot>=21
